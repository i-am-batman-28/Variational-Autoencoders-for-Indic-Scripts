#!/usr/bin/env python3
"""
Production-grade dataset generator for printed Hindi characters
Fonts: Akshar Unicode Regular, Mangal Regular
Alphabets: 12 vowels (a to aha)
"""
...
CONFIG = {
    'fonts': {
        'akshar': '/Users/karthiksarma/Library/Fonts/Akshar Unicode Regular.ttf',
        'mangal': '/Users/karthiksarma/Library/Fonts/Mangal Regular.ttf'
    },
...
# Hindi vowel characters (Devanagari Unicode)
# 13 vowels in correct order as per user requirement
HINDI_VOWELS = {
    'a': '\u0905',      # अ (A)
    'aa': '\u0906',     # आ (AA)
    'i': '\u0907',      # इ (E)
    ...
    'o': '\u0913',      # ओ (O)
    'au': '\u0914',     # औ (AO)
    'am': '\u0905\u0902',  # अं (AM) - अ + anusvara
    'aha': '\u0905\u0903'  # अ: (AH) - अ + visarga
}
...
def generate_dataset():
    ...
    print("=" * 70)
    print("PRODUCTION-GRADE DATASET GENERATION")
    print("=" * 70)
    ...
    # Update: 13 alphabets instead of 12
    ...
    for font_name, font_path in CONFIG['fonts'].items():
        ...
        for alphabet in tqdm(CONFIG['alphabets'], desc=f"  {font_name}"):
            ...
            character = HINDI_VOWELS.get(alphabet, alphabet)
            sample_count = 0
...
if __name__ == "__main__":
    ...
    for font_name, font_path in CONFIG['fonts'].items():
        if os.path.exists(font_path):
            ...
            test_path = f"test_{font_name}.png"
            test_img.save(test_path)
            print(f"✅ Test image saved: {test_path}")
    
    print("\n" + "=" * 70)
    print("Fonts verified. Generating full dataset...")
    generate_dataset()
