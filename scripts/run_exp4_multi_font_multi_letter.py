...
============================================================
Data:  lohit_telugu + pothana2000 / all 13 vowels / 4 point sizes
Goal:  Full-scale VAE evaluation: font × letter × size structure in latent space.
"""
...
cfg = ExperimentConfig(
    experiment_name="Exp4: Multi Font, Multi Letter (full scale)",
    ...
    image_size=128,
    batch_size=32,
    latent_dim=16,         # high-dim for full complexity
    lr=1e-3,
    epochs=250,
    ...
    output_dir=Path("results/exp4_multi_font_multi_letter"),
    seed=42,
)
