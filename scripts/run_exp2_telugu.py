#!/usr/bin/env python3
"""
Experiment 2 Telugu: Single Font (lohit_telugu), All 13 Vowels, 4 Point Sizes
"""
...
cfg = ExperimentConfig(
    experiment_name="Exp2 Telugu: Single Font, Multi Letter (lohit_telugu, 13 vowels)",
    ...
    output_dir=Path("results/exp2_telugu_single_font_multi_letter"),
    seed=42,
)
